...
<html lang="en">
    ...
    <body>
        <% session = request.getSession();
            List<Integer> admin_Sponsor_ID = (List) session.getAttribute("admin_Sponsor_ID");
            List<String> admin_Sponsor_Name = (List) session.getAttribute("admin_Sponsor_Name");
        %>
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-md-12">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <%
                                for (int i = 1; i <= admin_Sponsor_ID.size(); i++) {
                                    int index = admin_Sponsor_ID.indexOf(i);
                                    out.println("<tr>");
                                    out.println("<td class=\"sorting_1\">" + Integer.toString(admin_Sponsor_ID.get(index)) + "</td>");
                                    out.println("<td>" + admin_Sponsor_Name.get(index) + "</td>");
                                ...
                                int last_id = admin_Sponsor_ID.size()+1;
                            %>
                ...
                <p data-placement="top" data-toggle="tooltip" title="Add"><button class="btn btn-primary btn-xs" data-title="Add" data-toggle="modal" data-target="#add"><span class="glyphicon">CreateNewSponsor</span></button></p>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="AdminCheckSponsorServlet" method="POST">

                            <div class="form-group">
                                ID : <input name="admin_Sponsor_ID" class="form-control " type="text" value=<%=admin_Sponsor_ID.get(index)%> >
                            </div>

                            <div class="form-group">
                                Name : <input name="admin_Sponsor_Name" class="form-control " type="text" value=<%=admin_Sponsor_Name.get(index)%>>
                            </div>
                            <input name="admin_hide_Sponsor_ID" type="hidden" class="form-control " type="text" value=<%=admin_Sponsor_ID.get(index)%>>
            ...
            <div class="modal fade" id=<%=temp%> tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer ">
                            <form action="AdminDeleteSponsorServlet" method="POST">
                                <input name="admin_hide_Sponsor_ID" type="hidden" class="form-control " type="text" value=<%=admin_Sponsor_ID.get(index)%>>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="AdminAddSponsorServlet" method="POST">
                                ...
                                <div class="form-group">
                                    ID : <input name="admin_Sponsor_ID" class="form-control "  value=<%=last_id%>> 
                                </div>

                                <div class="form-group">
                                    Name : <input name="admin_Sponsor_Name" class="form-control " type="text">
                                </div>
