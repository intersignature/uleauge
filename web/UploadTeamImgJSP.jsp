    ...
    <body>
        ...
        <div class="row register-form">
            <div class="col-md-8 col-md-offset-2">
                <form class="form-horizontal custom-form" id="signup" name="signup" action="UploadTeamLogoServlet?Team_ID=<%=Team_ID%>" method="post"
                      enctype="multipart/form-data" >
                    <h1> Upload Team Logo</h1>
                    <input type="file" style="margin :0 auto;" name="file" size="50" />
                    <br />
