...
<body>
    <% session = request.getSession();
    List<Integer> admin_organizer_ID = (List) session.getAttribute("admin_organizer_ID");
    List<String> admin_Organizer_Name = (List) session.getAttribute("admin_Organizer_Name");
    %>
<div class="container" style="margin-left: 0cm;">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
                                            <%
                                        for(int i=1;i<=admin_organizer_ID.size();i++){
                                            int index = admin_organizer_ID.indexOf(i);
                                            out.println("<tr>");
                                            out.println("<td class=\"sorting_1\">"+Integer.toString(admin_organizer_ID.get(index))+"</td>");
                                            out.println("<td>"+admin_Organizer_Name.get(index)+"</td>");
        ...
        <p data-placement="top" data-toggle="tooltip" title="Add"><button class="btn btn-primary btn-xs" data-title="Add" data-toggle="modal" data-target="#add"><span class="glyphicon">CreateNewOrganizer</span></button></p>
                  </div>
...
<div class="modal fade" id="<%=temp%>" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Edit Your Detail</h4>
          ...
          <div class="form-group">
            Name : <input name="admin_Organizer_Name" class="form-control " type="text" value=<%=admin_Organizer_Name.get(index)%>>
          </div>
          <input name="admin_hide_organizer_ID" type="hidden" class="form-control " type="text" value=<%=admin_organizer_ID.get(index)%>>
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Record?</div>
        ...
        <div class="modal-footer ">
            <form action="AdminDeleteOrganizerServlet" method="POST">
                <input name="admin_hide_organizer_ID" type="hidden" class="form-control " type="text" value=<%=admin_organizer_ID.get(index)%>>
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Add New User</h4>
          ...
          <div class="form-group">
            Name : <input name="admin_Organizer_Name" class="form-control " type="text">
          </div>
