<%-- 
    Document   : CreateTeamSuccess
    Created on : 21 เม.ย. 2560, 23:14:20
    Author     : Barjord
--%>
    ...
    <body>
        ...
        <div class="row register-form">
            <div class="col-md-8 col-md-offset-2">
                <form action="#proModal" class="form-horizontal custom-form" id="signup" name="signup" method="POST">
                    <h1>Create team successful!!!</h1>
                    <br>
                    <a class="btn btn-primary btn-large" data-toggle="modal" href="#inviteModal">Invite Player</a> 
                    <div id="inviteModal" class="modal modal-wide fade" >
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header" align="center">
                                    <button class="close" data-dismiss="modal">×</button>
                                    <h3>Search for invite player</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <form class="form-horizontal" align="center">
                                            <div class="input-prepend">
                                                <span class="add-on">Username:</span><span style="display:inline-block; width: 10px;"></span><input type="text" name="searchname"  maxlength="20"style=" font-weight: normal;" class="prependedInput" size="20">
                                            </div>

                                            <div class="help-block">
                                                <br>
                                                <button type="submit" class="btn btn-large btn-info " data-dismiss="modal" data-toggle="modal" href="#proModal">Search</button>
                                            </div>
                    ...
                    <div id="proModal" class="modal modal-wide fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button class="close" data-dismiss="modal">×</button>
                                    <h3><%= request.getParameter("searchname") %></h3>
                                </div>
                                <div class="modal-body">
                                    <div class="row-fluid">
                                        <div class="span12">

                                            <div class="logowrapper"  style="margin-top: -20px;">
                                                ...
                                                <div class="span6" style="float:right; margin-right: 50px;">
                                                    <form class="form-horizontal">
                                                        ...
                                                        <hr>
                                                        <div class="help-block" style="float:right; margin-right: 50px;">
