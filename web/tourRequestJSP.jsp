<%-- 
    Document   : tourRequestJSP
    Created on : 22 เม.ย. 2560, 20:00:46
    Author     : Barjord
--%>
...
<body>
    ...
    <% int suc = 0;
        ...
        response.sendRedirect("tourRequestJSP.jsp");
    %>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-2">
          ...
          <div class="collapse nav navbar-nav nav-collapse slide-down" id="nav-collapse2">
            <form action="SigninServlet" method="POST" class="navbar-form navbar-right form-inline" role="form">
                 <input type="hidden" name="from" value="tourRequestJSP.jsp" />
            ...
            <form class="form-horizontal custom-form" action="TourRequestServlet" id="signup" name="signup" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 input-column">
                        <input class="form-control" type="text" name="teamname"> <p>*Require<br>  ชื่อทีมหรือองค์กร</p>
                    </div>
                    </div>
                <div class="form-group">
                    <div class="col-sm-4 label-column">
                    ...
                    <div class="col-sm-6 input-column">
                        <input class="form-control" type="text" name="address"><p>*Require</p>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 input-column">
                        ...
                        <p>*Require<br>  เช่น สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง</p>  
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 input-column">
                        ...
                        <p>*Require<br> เช่น OVERWATCH KMITL SUMMER TOURNAMENT<br>  *ถ้าไม่เคยจัดการแข่งขันให้ใส่ - </p>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 input-column">
                        <input class="form-control" type="text" name="promote">
                        <p>*Require<br>  เช่น 1.ทำแบนเนอร์ 2.โพสลงเฟสบุ้ค 3.โพสลงอินสตาแกรม</p>
                    </div>
