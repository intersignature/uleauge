...
public final class inviteFail_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.println(id);
 ...
 out.println(username); 
      ...
      out.write("                            <input type=\"hidden\" name=\"from\" value=\"inviteFail.jsp\" />\r\n");
      out.write("                            <li >\r\n");
      ...
      out.write("                    <h1><u> <b>ไม่สามารถชวนผู้เล่นนี้ได้</b></u></h1>\r\n");
      out.write("                    \r\n");
      out.write("                     ");
 if ((int)session.getAttribute("invited")  == 1) { 
      out.write("\r\n");
      out.write("                     <h1>- เคยชวนผู้เล่นคนนี้ไปแล้ว</h1>\r\n");
      out.write("                     \r\n");
      out.write("                      ");
 } else if ((int) session.getAttribute("haveteam") == 1) {
      out.write("\r\n");
      out.write("                      \r\n");
      out.write("                      <h1>- ผู้เล่นคนนี้มีทีมอยู่แล้ว</h1>\r\n");
      out.write("                      \r\n");
      out.write("                ");
 } else if ((int) session.getAttribute("notcap") == 1) {
      out.write("\r\n");
      out.write("                    <h1>- คุณไม่ได้เป็นกัปตันทีม</h1>\r\n");
      out.write("                ");
 } else if ((int) session.getAttribute("notfull") == 1) {
      out.write("\r\n");
      out.write("                    <h1>- ทีมของคุณเต็มแล้ว</h1>\r\n");
      out.write("                ");
}
      out.write("\r\n");
      out.write("                    \r\n");
