            ...
            <div class="col-md-8 col-md-offset-2">
                <form class="form-horizontal custom-form" action="TourRequestServlet" id="signup" name="signup" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <p id="cau_university" style="color:blue;"><%if (is_teamname == '1') {
                            out.println("คุณต้องกรอกชื่อทีม");
                        }%></p>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <p id="cau_university" style="color:blue;"><%if (is_address == '1') {
                            out.println("คุณต้องกรอกที่อยู่ที่ติดต่อได้");
                        }%></p>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <p id="cau_university" style="color:blue;"><%if (is_location == '1') {
                            out.println("คุณต้องกรอกสถานที่จัดการแข่ง");
                        }%></p>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <p id="cau_university" style="color:blue;"><%if (is_exp == '1') {
                            out.println("คุณต้องกรอกประสบการณ์การจัดการแข่งขัน");
                        }%></p>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                        ...
                        <p id="cau_university" style="color:blue;"><%if (is_promote == '1') {
                            out.println("คุณต้องกรอกวิธีการโปรโมต");
                        }%></p>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                    ...
                    <div class="form-group">
                        ...
                        <p id="cau_university" style="color:blue;"><%if (is_cause == '1') {
                            out.println("คุณต้องกรอกเหตุผลการจัดการแข่งขัน");
                        }%></p>
                    </div>
