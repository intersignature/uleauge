                ...
                <div class="col-md-8 col-md-offset-2">
                    <form class="form-horizontal custom-form" action="CreateTeamServlet" id="signup" name="signup" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <p id="cau_password" style="color:blue;"><%if (ans_teamname == 0) {
                            out.println("Incorrect Team name or Team name have already exist");
                        }%></p>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
                            ...
                            <p id="cau_password" style="color:blue;"><%if (ans_teamtag == 0) {
                             out.println("Incorrect Team Tag or Team Tag have already exist");
                         }%></p>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
                            ...
                            <p id="cau_password" style="color:blue;"><%if (ans_teamnunjoin == 0) {
                            out.println("You already exist team in this game");
                        }%>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
                            ...
                            <p id="cau_phone" style="color:blue;"><%if (ans_teamphone == 0) {
